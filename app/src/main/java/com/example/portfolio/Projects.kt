...
class Projects : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var app = findViewById<Button>(R.id.app)
        var ui = findViewById<Button>(R.id.ui)

        var toolbar : Toolbar = findViewById(R.id.toolbar)
        setSupportActionBar(toolbar)

        web.setOnClickListener {
            var intent = Intent(this@Projects, WebProjects::class.java)
            startActivity(intent)
        }

        app.setOnClickListener {
            var intent = Intent(this@Projects, AppProjects::class.java)
            startActivity(intent)
        }

        ui.setOnClickListener {
            var intent = Intent(this@Projects, UIUXProjects::class.java)
            startActivity(intent)
        }
